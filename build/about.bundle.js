...
/***/ function(module, exports, __webpack_require__) {
	...
	var _preact = __webpack_require__(60);
	...
	var Team = function (_Component) {
	  ...
	  _createClass(Team, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      fetch('/datas/Team.json').then(function (res) {
	        return res.json();
	      }).then(function (json) {
	        _this2.setState({ members: json._ });
	      }).catch(function (err) {
	        console.log('fetch error', err);
	      });
	    }
	  }, {
	    key: 'displaySocialLink',
	    value: function displaySocialLink(type, text) {
	      if (type == 'website') {
	          ...
	          (0, _preact.h)(
	            ...
	            members.map(function (member) {
	              return (0, _preact.h)(
	                'article',
	                { className: 'member' },
	                (0, _preact.h)('img', { className: 'u-max-full-width member-avatar', src: '/medias/team/' + member.name.toLowerCase().replace(/é|è|ê/gi, "e") + '.png' }),
	                (0, _preact.h)(
	                  'div',
	                  { className: 'member-heading' },
	                  (0, _preact.h)(
	                    'h4',
	                    null,
	                    member.position
	                ...
	                (0, _preact.h)(
	                  'div',
	                  { className: 'social member-social' },
	                  (0, _preact.h)(
	                    'ul',
	                    null,
	                    Object.keys(member.social).map(function (prop) {
	                      return (0, _preact.h)(
	                        'li',
	                        { className: prop },
	                        (0, _preact.h)(
	                          'a',
	                          { target: '_blank', href: member.social[prop], title: prop },
	                          _this3.displaySocialLink(prop, member.social[prop])
	                        )
	                      );
	                    })
	                  )
	...
	var Layout = function (_Component) {
		...
		_createClass(Layout, [{
			...
			value: function componentDidMount() {
				...
				fetch('/datas/Page.About.json').then(function (res) {
					return res.json();
				}).then(function (json) {
					_this2.setState({
						team: (0, _preact.h)(_Team2.default, { metas: json })
					});
				}).catch(function (err) {
					console('error', err);
				});
			...
			value: function render(_ref, state) {
				...
				return (0, _preact.h)(
					'div',
					null,
					(0, _preact.h)(_Header2.default, { title: '\xC0 propos', back: { href: '/', text: 'Retour à l\'accueil' } }),
					state.team,
					state.footer
				);
			}
