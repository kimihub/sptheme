...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(299)(module), __webpack_require__(298)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(120));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    key: 'displayLink',
	    value: function displayLink(link, i) {
	      if (link.type === 'url') {
	        return (0, _preact.h)(
	          'a',
	          { key: i, target: '_blank', href: link.href },
	          link.name
	        );
	      }
	    }
	    ...
	    value: function displayBack() {
	      if (this.props.back) {
	        return (0, _preact.h)(
	          'a',
	          { className: 'header-back', href: this.props.back.href },
	    ...
	    value: function render() {
	      return (0, _preact.h)(
	        'section',
	        { className: 'header' + (this.props.nav ? ' with-nav' : '') },
	        (0, _preact.h)(
	          'div',
	          { className: 'container' },
	          (0, _preact.h)(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fanzines = function (_Component) {
	  _inherits(Fanzines, _Component);

	  function Fanzines(props) {
	    _classCallCheck(this, Fanzines);

	    var _this = _possibleConstructorReturn(this, (Fanzines.__proto__ || Object.getPrototypeOf(Fanzines)).call(this, props));
	  ...
	  _createClass(Fanzines, [{
	    key: 'displayLink',
	    value: function displayLink(link) {
	      return (0, _preact.h)(
	        'p',
	        { className: 'link' },
	        (0, _preact.h)(
	          'a',
	          { className: 'button', target: '_blank', href: link },
	          this.displayLinkName(link)
	        )
	      );
	    }
	  }, {
	    key: 'displayLinkName',
	    value: function displayLinkName(href) {
	      if (href.slice(-4) === '.pdf') {
	        return 'Télécharger';
	      } else {
	        return 'Acheter';
	            ...
	            (0, _preact.h)(
	              ...
	              items.map(function (i) {
	                return (0, _preact.h)(
	                  ...
	                  { className: 'item' },
	                  (0, _preact.h)('hr', null),
	                  (0, _preact.h)('img', { className: 'u-max-full-width cover', src: '/medias/' + type + '/' + i.image }),
	                  (0, _preact.h)(
	                    'h5',
	                    null,
	                    i.name
	                  ...
	                  i.link ? _this3.displayLink(i.link) : (0, _preact.h)('div', null),
	                  (0, _preact.h)('div', { className: 'u-cf' })
	                );
	              })
	            )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Intro = __webpack_require__(303);

	var _Intro2 = _interopRequireDefault(_Intro);

	var _Publications = __webpack_require__(304);
	...
	var Layout = function (_Component) {
		...
		function Layout() {
			...
			_this.state = {
				...
				figurines: (0, _preact.h)('div'),
				artbooks: (0, _preact.h)('div'),
				fanzines: (0, _preact.h)('div'),
		...
		_createClass(Layout, [{
			...
			value: function componentDidMount() {
				...
				fetch('/datas/Page.Publications.json').then(function (res) {
					return res.json();
				}).then(function (json) {
					_this2.setState({
						figurines: (0, _preact.h)(_Publications2.default, { type: 'figurines', title: json.figurines_title, subtitle: json.figurines_subtitle }),
						artbooks: (0, _preact.h)(_Publications2.default, { type: 'artbooks', title: json.artbooks_title, subtitle: json.artbooks_subtitle }),
						fanzines: (0, _preact.h)(_Publications2.default, { type: 'fanzines', title: json.fanzines_title, subtitle: json.fanzines_subtitle }),
						intro: (0, _preact.h)(_Intro2.default, { text: json.intro })
					});
				}).catch(function (err) {
					console('error', err);
				});
			...
			value: function render(_ref, state) {
				...
				return (0, _preact.h)(
					'div',
					null,
					(0, _preact.h)(_Header2.default, { title: 'Publications', back: { href: '/', text: 'Retour à l\'accueil' } }),
					state.intro,
					state.figurines,
					state.artbooks,
					state.fanzines,
...
/***/ }
/******/ ]);
//# sourceMappingURL=publications.bundle.js.map